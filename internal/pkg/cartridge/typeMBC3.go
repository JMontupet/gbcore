...
func newMBC3(data []byte) Cartridge {
	cartridge := &mbc3{
		data:    data,
		romBank: 1,
	}
	...
	default:
		panic(fmt.Sprintf("RAM SIZE NOT MANAGED FOR MBC3 : 0x%02X", ramSize))
	}
	...
	default:
		panic(fmt.Sprintf("ROM SIZE NOT MANAGED FOR MBC3 : 0x%02X", romSize))
	}
